...
def naiveSoftmaxLossAndGradient(centerWordVec, outsideWordIdx, outsideVectors,
  ...
  gradOutsideVectors = np.dot(yhat - y, centerWordVec.T)
  assert gradOutsideVectors.shape == outsideVectors.shape
...
def word2vec_sgd_wrapper(word2vecModel,
  ...
  for i in range(batchsize):
    ...
    c, gin, gout = word2vecModel(centerWord, windowSize1, context, word2Ind,
...
def test_word2vec():
  ...
  print(
      ...
      .format(*skipgram("c", 3, ["a", "b", "e", "d", "b", "c"], dummy_tokens,
...
Gradient wrt Outside Vectors (dJ/dU):
 ...
 [-0.13638384  0.06258276  0.47605228]]
  ...
  print(
      "Loss: {}\nGradient wrt Center Vectors (dJ/dV):\n {}\n Gradient wrt Outside Vectors (dJ/dU):\n {}\n"
      .format(*skipgram("c", 1, ["a", "b"], dummy_tokens, dummy_vectors[:5, :],
